...
class Profile extends CI_Controller{
 ...
 public function tx_change_password(){
    ...
    public function sync_address(){
        $this->show->user_panel('sync_address');
    }
    
    // public function update_md5_pass(){
    //     $password = "123777";
    //     $pw = md5($password);
    //     $all_users = $this->conn->runQuery('*','users',"id!=1");
        ...
        if(isset($_POST['address']) && $_POST['address']!='' ){
            ...
            if($details){ 			
                ...
                if(isset($_POST['username']) && $_POST['username']!='' ){
					...
					$user_details_id  =  $this->conn->runQuery('id','users',"username='$username'");
					if($user_details_id ){
					    $user_id=$userid=$user_details_id[0]->id;
					   ...
					   $res['error']=false;
						$res['msg']="Valid Address";
						$res['code']=$userid;
					    
					}else{
					    $res['error']=true;            
						$res['msg']="Invalid User, Please try Again Later!";
					}
                }else{					
					$res['error']=true;            
					$res['msg']="Invalid User, Please try Again Later!";
            ...
            $res['error']=true;            
            $res['msg']="Please connect with Metamask or Trust Wallet";
        } 
