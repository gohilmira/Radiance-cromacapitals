...
<div id="content" class="app-content">
    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="pin_top_page_content">
                        ...
                        if ($this->conn->setting('topup_type') == 'pin') {
                            ?>
                            <h5>Pin Available</h5>
                            <span id="total_pins" class=""><i class="fa fa-thumb-tack" aria-hidden="true"></i>&nbsp;
                                <?= $cnt_pins; ?>
                            </span>
                        <?php } ?>
                    </div>
                    <form action="" method="post">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="tx_username" value="<?= $profile->username; ?>"
                                    data-response="username_res" class="form-control check_username_exist"
                                    placeholder="Enter User ID" aria-describedby="helpId" readonly>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="horizontal-password-input"
                                    placeholder="Enter Amount" name="amount" value="<?= set_value('amount'); ?>">
                                <span class="text-danger">
                                    <?= form_error('amount'); ?>
                                </span>
                            </div>
                        ...
                        if ($profile_edited != 'readonly') {
                            ...
                            if ($invest_toup_with_otp == 'yes') {
                                ...
                                ?>
                                <button type="button" data-response_area="action_areap" class="user_btn_button send_otp">Send
                                    OTP</button>
                                ...
                                <div id="action_areap" style="display:<?= $display; ?>">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="otp_input1" id="otp_input1"
                                                value="<?= set_value('otp_input1'); ?>" class="form-control user_input_text"
                                                placeholder="Enter OTP" aria-describedby="helpId">
                                            <span class=" ">
                                    ...
                                    <input type="submit" class="user_btn_button btn-remove btn btn-primary" name="topup_btn"
                                        onclick="return confirm('Are you sure? you wants to Submit.')" value="Retopup">
                                    ...
                                    <div class="col-sm-9">
                                        <div>
                                            <button type="submit" class="btn btn-primary w-md" name="topup_btn"
                                                onclick="return confirm('Are you sure? you wants to Submit.')">Upgrade</button>
                                        </div>
                                    </div>
                                </div>
                                <?php
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">STEPS FOR UPGRADE</h4>
                    <div class="table-responsive">
                        <p><i class="fa-solid fa-check-to-slot me-2" aria-hidden="true"></i> <b
                                class="text-danger">*</b>Enter Amount in $ to Activate</p>
                        <p><i class="fa-solid fa-check-to-slot me-2" aria-hidden="true"></i> <b
                                class="text-danger">*</b> Upgrade is available with minimum of $50</p>
