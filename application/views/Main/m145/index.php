...
<section class="banner banner--style1" style="padding-bottom: 100px !important;">
    <div class="banner__bg">
      <div class="banner__bg-element">
        <img src="<?= $panel_url;?>assets/images/bg.png" alt="section-bg-element" class="dark d-none d-lg-block">
        ...
        <div class="row gy-5 gx-4">
          <div class="col-lg-6 col-md-7">
            <div class="banner__content" data-aos="fade-right" data-aos-duration="1000">
              <div class="banner__content-coin">
                <img src="<?= $panel_url;?>assets/images/3.png" alt="coin icon">
              </div>
              <h1 class="banner__content-heading">Invest your money  <span>higher return</span></h1> 
              <p class="banner__content-moto">Anyone can invest money to different currency to increase their earnings
                by the help of Bitrader through online.Anyone can invest money to different currency to increase their earnings
                by the help of Bitrader through online.Anyone can invest money to different currency to increase their earnings
                by the help of Bitrader through online.Anyone can invest money to different currency to increase their earnings
                by the help of Bitrader through online.Anyone can invest money to different currency to increase their earnings
                by the help of Bitrader through online.Anyone can invest money to different currency to increase their earnings
              ...
              <div class="banner__btn-group btn-group justify-content-between">
                <a href="<?= base_url(); ?>login" class="trk-btn trk-btn--primary trk-btn--arrow">Get Started
                  ...
                  <div class="banner__content-social">
                    ...
                    <ul class="social">
                      ...
                      <li class="social__item">
                        <a href="<?= base_url(); ?>login" class="social__link social__link--style1"><i class="fab fa-twitter"></i></a>
                      </li>
                    </ul>
                  </div>
              </div>
          ...
          <div class="col-lg-6 col-md-5">
            <div class="banner__thumb" data-aos="fade-left" data-aos-duration="1000">
              <img width="650" src="<?= $panel_url;?>assets/images/1_10.png" alt="banner-thumb" >
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="banner__shape">
      <span class="banner__shape-item banner__shape-item--1"><img src="<?= $panel_url;?>assets/images/4.png" alt="shape icon"></span>
    </div>
            ...
            <div class="swiper-slide">
              <div class="partner__item">
                <div class="partner__item-inner">
                  <img src="<?= $panel_url;?>assets/images/1.png" alt="partner logo" class="">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner__item">
                <div class="partner__item-inner">
                  <img src="<?= $panel_url;?>assets/images/2.png" alt="partner logo" class="">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner__item">
                <div class="partner__item-inner">
                  <img src="<?= $panel_url;?>assets/images/3_1.png" alt="partner logo" >
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner__item">
                <div class="partner__item-inner">
                  <img src="<?= $panel_url;?>assets/images/4_1.png" alt="partner logo" class="">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner__item">
                <div class="partner__item-inner">
                  <img src="<?= $panel_url;?>assets/images/5.png" alt="partner logo" >
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row g-4 align-items-center">
            ...
            <div class="service__item service__item--style1" data-aos="fade-up" data-aos-duration="800">
              <div class="service__item-inner text-center">
                <div class="service__item-thumb mb-30">
                  <img  src="<?= $panel_url;?>assets/images/4_2.png" alt="service-icon">
                </div>
                <div class="service__item-content">
                  <h5> <a class="stretched-link" href="<?= base_url(); ?>about">Supply Optimization </a>
                  </h5>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="service__item service__item--style1" data-aos="fade-up" data-aos-duration="1000">
              <div class="service__item-inner text-center">
                <div class="service__item-thumb mb-30">
                  <img  src="<?= $panel_url;?>assets/images/5_2.png" alt="service-icon">
                </div>
                <div class="service__item-content">
                  <h5> <a class="stretched-link" href="<?= base_url(); ?>about">HR consulting</a> </h5>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="service__item service__item--style1" data-aos="fade-up" data-aos-duration="1200">
              <div class="service__item-inner text-center">
                <div class="service__item-thumb mb-30">
                  <img  src="<?= $panel_url;?>assets/images/6_1.png" alt="service-icon">
                </div>
                <div class="service__item-content">
                  <h5> <a class="stretched-link" href="<?= base_url(); ?>about">Marketing consulting</a>
                  </h5>
            ...
            <div class="about__thumb pe-lg-5" data-aos="fade-right" data-aos-duration="800">
              <div class="about__thumb-inner">
                <div class="about__thumb-image floating-content">
                  <img src="<?= $panel_url;?>assets/images/1_12.png" alt="about-image">
          ...
          <div class="col-lg-6">
            <div class="about__content" data-aos="fade-left" data-aos-duration="800">
              <div class="about__content-inner">
                ...
                <a href="<?= base_url(); ?>about" class="trk-btn trk-btn--border trk-btn--primary">Explore More </a>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="feature feature--style1 padding-bottom padding-top bg-color">
                ...
                <div class="tab-content" id="feat-pills-tabContent">
                  <div class="tab-pane fade show active" id="feat-pills-one" role="tabpanel" aria-labelledby="feat-pills-one-tab" tabindex="0">
                    <div class="feature__image floating-content">
                      <img src="<?= $panel_url;?>assets/images/1_7.png" alt="Feature image">
                      <div class="floating-content__top-right floating-content__top-right--style2" data-aos="fade-left" data-aos-duration="1000">
                        <div class="floating-content__item floating-content__item--style2 text-center">
                          <img src="<?= $panel_url;?>assets/images/5_1.png" alt="rating">
                  ...
                  <div class="tab-pane fade" id="feat-pills-two" role="tabpanel" aria-labelledby="feat-pills-two-tab" tabindex="0">
                    <div class="feature__image floating-content">
                      <img src="<?= $panel_url;?>assets/images/2_7.png" alt="Feature image">
                      <div class="floating-content__top-right floating-content__top-right--style2" data-aos="fade-left" data-aos-duration="1000">
                        <div class="floating-content__item floating-content__item--style2 text-center">
                          <img src="<?= $panel_url;?>assets/images/6.png" alt="rating">
                          <p class="style2">Interest Rate For Loan</p>
                        </div>
                      </div>
                      <div class="floating-content__bottom-left floating-content__bottom-left--style2" data-aos="fade-left" data-aos-duration="1000">
                  ...
                  <div class="tab-pane fade" id="feat-pills-three" role="tabpanel" aria-labelledby="feat-pills-three-tab" tabindex="0">
                    <div class="feature__image floating-content">
                      ...
                      <div class="floating-content__top-right floating-content__top-right--style2" data-aos="fade-left" data-aos-duration="1000">
                        <div class="floating-content__item floating-content__item--style2 text-center">
                          <img src="<?= $panel_url;?>assets/images/7.png" alt="rating">
                          <p class="style2">Interest Rate For Loan</p>
                        </div>
                      </div>
                      <div class="floating-content__bottom-left floating-content__bottom-left--style2" data-aos="fade-left" data-aos-duration="1000">
                  ...
                  <div class="tab-pane fade" id="feat-pills-four" role="tabpanel" aria-labelledby="feat-pills-four-tab" tabindex="0">
                    <div class="feature__image floating-content">
                      ...
                      <div class="floating-content__top-right floating-content__top-right--style2" data-aos="fade-left" data-aos-duration="1000">
                        <div class="floating-content__item floating-content__item--style2 text-center">
                          <img src="<?= $panel_url;?>assets/images/8.png" alt="rating">
                          <p class="style2">Interest Rate For Loan</p>
                        </div>
                      </div>
                      <div class="floating-content__bottom-left floating-content__bottom-left--style2" data-aos="fade-left" data-aos-duration="1000">
    ...
    <div class="feature__shape">
      <span class="feature__shape-item feature__shape-item--1"><img src="<?= $panel_url;?>assets/images/1_3.png" alt="shape-icon"></span>
  ...
  <section class="roadmap roadmap--style1 padding-top  padding-bottom bg-color" id="roadmap">
    ...
    <div class="roadmap__shape">
      ...
      <span class="roadmap__shape-item roadmap__shape-item--2"> <img src="<?= $panel_url;?>assets/images/1_2.png" alt="shape-icon">
      </span>
    </div>
  </section>
  ...
  <section class="pricing padding-top padding-bottom">
                ...
                <div class="pricing__item-content">
                  ...
                  <div class="pricing__item-middle">
                    <ul class="pricing__list">
                      <li class="pricing__list-item"><span><img src="<?= $panel_url;?>assets/images/check.svg" alt="check" class="dark"></span>
                  ...
                  <div class="pricing__item-bottom">
                    <a href="<?= base_url(); ?>register" class="trk-btn trk-btn--outline">Choose Plan</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="pricing__item " data-aos="fade-up" data-aos-duration="1000">
              <div class="pricing__item-inner active">
                <div class="pricing__item-content">
                  ...
                  <!-- pricing bottom part -->
                  <div class="pricing__item-bottom">
                    <a href="<?= base_url(); ?>about" class="trk-btn trk-btn--outline active">Choose Plan</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="pricing__item" data-aos="fade-left" data-aos-duration="1000">
              <div class="pricing__item-inner">
                <div class="pricing__item-content">
                  ...
                  <!-- pricing bottom part -->
                  <div class="pricing__item-bottom">
                    <a href="<?= base_url(); ?>about" class="trk-btn trk-btn--outline">Choose Plan</a>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="pricing__shape">
      ...
      <span class="pricing__shape-item pricing__shape-item--2"> <img src="<?= $panel_url;?>assets/images/1_2.png" alt="shape-icon">
      </span>
    </div>
  </section>
  <!-- ===============>> Pricing section start here <<================= -->
        ...
        <div class="row g-4 align-items-center">
            ...
            <div class="team__item team__item--shape" data-aos="fade-up" data-aos-duration="800">
              <div class="team__item-inner team__item-inner--shape">
                <div class="team__item-thumb team__item-thumb--style1">
                  <img src="<?= $panel_url;?>assets/images/1-dark.png" alt="Team Image" class="dark">
                </div>
                <div class="team__item-content team__item-content--style1">
                  <div class="team__item-author team__item-author--style1">
                    <div class="team__item-authorinfo">
                      <h6 class="mb-1"><a href="<?= base_url(); ?>about" class="stretched-link">Dianne Russell</a> </h6>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="team__item team__item--shape" data-aos="fade-up" data-aos-duration="900">
              <div class="team__item-inner team__item-inner--shape">
                <div class="team__item-thumb team__item-thumb--style1">
                  <img src="<?= $panel_url;?>assets/images/2-dark.png" alt="Team Image" class="dark">
                </div>
                <div class="team__item-content team__item-content--style1">
                  <div class="team__item-author team__item-author--style1">
                    <div class="team__item-authorinfo">
                      <h6 class="mb-1"><a href="<?= base_url(); ?>about" class="stretched-link">Theresa Webb</a> </h6>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="team__item team__item--shape" data-aos="fade-up" data-aos-duration="1000">
              <div class="team__item-inner team__item-inner--shape">
                <div class="team__item-thumb team__item-thumb--style1">
                  <img src="<?= $panel_url;?>assets/images/3-dark.png" alt="Team Image" class="dark">
                </div>
                <div class="team__item-content team__item-content--style1">
                  <div class="team__item-author team__item-author--style1">
                    <div class="team__item-authorinfo">
                      <h6 class="mb-1"><a href="<?= base_url(); ?>about" class="stretched-link">Courtney Henry</a> </h6>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="team__item team__item--shape" data-aos="fade-up" data-aos-duration="1100">
              <div class="team__item-inner team__item-inner--shape">
                <div class="team__item-thumb team__item-thumb--style1">
                  <img src="<?= $panel_url;?>assets/images/4-dark.png" alt="Team Image" class="dark">
                </div>
                <div class="team__item-content team__item-content--style1">
                  <div class="team__item-author team__item-author--style1">
                    <div class="team__item-authorinfo">
                      <h6 class="mb-1"><a href="<?= base_url(); ?>about" class="stretched-link">Albert Flores</a> </h6>
          ...
          <div class="text-center">
            <a href="<?= base_url(); ?>about" class="trk-btn trk-btn--border trk-btn--primary mt-25">View more </a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="blog padding-top padding-bottom">
    <div class="container">
          ...
          <div class="swiper-wrapper">
              ...
              <div class="blog__item blog__item--style2">
                <div class="blog__item-inner">
                  <div class="blog__thumb">
                    <img src="<?= $panel_url;?>assets/images/1_9.png" alt="blog Images">
                  </div>
                  ...
                  <div class="blog__content">
                    ...
                    <h5 class="10"> <a href="<?= base_url(); ?>about">Swing Trading Definition</a> </h5>
                    ...
                    <div class="blog__writer">
                      <div class="blog__writer-thumb">
                        <img src="<?= $panel_url;?>assets/images/1_5.png" alt="writer">
                      </div>
            ...
            <div class="swiper-slide">
              <div class="blog__item blog__item--style2">
                <div class="blog__item-inner">
                  <div class="blog__thumb">
                    <img src="<?= $panel_url;?>assets/images/2_8.png" alt="blog Images">
                  </div>
                  ...
                  <div class="blog__content">
                    ...
                    <h5 class="10"> <a href="<?= base_url(); ?>about">hedge funds work?</a> </h5>
                    ...
                    <div class="blog__writer">
                      <div class="blog__writer-thumb">
                        <img src="<?= $panel_url;?>assets/images/2_2.png" alt="writer">
                      </div>
                      <div class="blog__writer-designation">
            ...
            <div class="swiper-slide">
              <div class="blog__item blog__item--style2">
                <div class="blog__item-inner">
                  <div class="blog__thumb">
                    <img src="<?= $panel_url;?>assets/images/3_5.png" alt="blog Images">
                  </div>
                  ...
                  <div class="blog__content">
                    ...
                    <h5 class="10"> <a href="<?= base_url(); ?>about">Options Trading business?</a> </h5>
                    ...
                    <div class="blog__writer">
                      <div class="blog__writer-thumb">
                        <img src="<?= $panel_url;?>assets/images/3_4.png" alt="writer">
                      </div>
                      <div class="blog__writer-designation">
      ...
      <div class="text-center">
        <a href="<?= base_url(); ?>about" class="trk-btn trk-btn--border trk-btn--primary mt-15">View more </a>
      </div>
    </div>
                    ...
                    <div class="testimonial__footer">
                      <div class="testimonial__author">
                        <div class="testimonial__author-thumb">
                          <img src="<?= $panel_url;?>assets/images/1_4.png" alt="author">
                        </div>
                ...
                <div class="testimonial__item-inner">
                  <div class="testimonial__item-content">
                    ...
                    <div class="testimonial__footer">
                      <div class="testimonial__author">
                        <div class="testimonial__author-thumb">
                          <img src="<?= $panel_url;?>assets/images/2_3.png" alt="author">
                        </div>
                        <div class="testimonial__author-designation">
                          <h6>Guy Hawkins</h6>
                ...
                <div class="testimonial__item-inner">
                  <div class="testimonial__item-content">
                    ...
                    <div class="testimonial__footer">
                      <div class="testimonial__author">
                        <div class="testimonial__author-thumb">
                          <img src="<?= $panel_url;?>assets/images/6_2.png" alt="author">
                        </div>
                        <div class="testimonial__author-designation">
                          <h6>Belal Hossain</h6>
  ...
  <section class="faq padding-top padding-bottom of-hidden">
        ...
        <div class="row g-5 align-items-center justify-content-between">
          ...
          <div class="col-lg-6">
            <div class="faq__thumb faq__thumb--style1" data-aos="fade-left" data-aos-duration="1000">
              <img  src="<?= $panel_url;?>assets/images/1_11.png" alt="faq-thumb">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="faq__shape faq__shape--style1">
      <span class="faq__shape-item faq__shape-item--1"><img src="<?= $panel_url;?>assets/images/2_5.png" alt="shpae-icon"></span>
    </div>
  </section>
  <!-- ===============>> FAQ section start here <<================= -->
    ...
    <div class="container">
      <div class="cta__wrapper">
        <div class="cta__newsletter justify-content-center">
          <div class="cta__newsletter-inner" data-aos="fade-up" data-aos-duration="1000">
            <div class="cta__thumb">
              <img src="<?= $panel_url;?>assets/images/3_7.png" alt="cta-thumb">
            </div>
        ...
        <div class="cta__shape">
          <span class="cta__shape-item cta__shape-item--1"><img src="<?= $panel_url;?>assets/images/2_4.png" alt="shape icon"></span>
          <span class="cta__shape-item cta__shape-item--2"><img src="<?= $panel_url;?>assets/images/4_4.png" alt="shape icon"></span>
          <span class="cta__shape-item cta__shape-item--3"><img src="<?= $panel_url;?>assets/images/5_4.png" alt="shape icon"></span>
        </div>
      </div>
    </div>
  </section>
