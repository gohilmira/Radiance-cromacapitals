...
<section class="page-header bg--cover" style="background-image:url(<?= $panel_url;?>assets/images/header/1.png)">
  ...
  <div class="contact padding-top padding-bottom">
            ...
            <div class="contact__info" data-aos="fade-right" data-aos-duration="1000">
              <div class="contact__social">
                ...
                <ul class="social">
                  ...
                  <li class="social__item">
                    <a href="<?= base_url();?>login" class="social__link social__link--style4"><i class="fab fa-twitter"></i></a>
                  </li>
                </ul>
              </div>
              <div class="contact__details">
                <div class="contact__item" data-aos="fade-right" data-aos-duration="1000">
                  <div class="contact__item-inner">
                    <div class="contact__item-thumb">
                      <span><img src="<?= $panel_url;?>assets/images/contact/1.png" alt="contact-icon" ></span>
                    </div>
                ...
                <div class="contact__item" data-aos="fade-right" data-aos-duration="1100">
                  <div class="contact__item-inner">
                    <div class="contact__item-thumb">
                      <span><img src="<?= $panel_url;?>assets/images/contact/2.png" alt="contact-icon" ></span>
                    </div>
                    <div class="contact__item-content">
                      <p>
                        Bitrader@gmail.com
                ...
                <div class="contact__item" data-aos="fade-right" data-aos-duration="1200">
                  <div class="contact__item-inner">
                    <div class="contact__item-thumb">
                      <span><img src="<?= $panel_url;?>assets/images/contact/3.png" alt="contact-icon" ></span>
                    </div>
                    <div class="contact__item-content">
                      <p>
                        88 Sheridan Street
    ...
    <div class="contact__shape">
      <span class="contact__shape-item contact__shape-item--1"><img src="<?= $panel_url;?>assets/images/contact/4.png"
          alt="shape-icon"></span>
